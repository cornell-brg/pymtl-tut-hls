...
set_directive_interface -mode ap_hs $top pe.req
set_directive_interface -mode ap_hs $top pe.resp

set_directive_data_pack $top pe.req
set_directive_data_pack $top pe.resp
