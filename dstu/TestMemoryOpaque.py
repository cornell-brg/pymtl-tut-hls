...
# memory messages with the _opaque_ fields.
...
from MemMsgFuture import MemMsg, MemReqMsg, MemRespMsg
...
class TestMemory (Model):
  ...
  def __init__( s, mem_ifc_types=MemMsg(8,32,32), nports=1,
